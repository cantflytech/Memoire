...
<template>
  <main class="bg-[#F8FAFB] font-['Inter'] flex items-center justify-center">
    <div v-if="loading" class="text-center text-gray-400 font-bold py-12">
      Génération de ta projection patrimoniale...
    </div>

    <div v-else class="max-w-7xl w-full bg-white p-6 rounded-[28px] shadow-sm border border-gray-100">
      ...
      <header class="flex justify-between items-center mb-6">
        <div class="flex items-center gap-2.5">
          ...
          <h3 class="heading text-xl green">Projection Patrimoniale</h3>
        </div>
